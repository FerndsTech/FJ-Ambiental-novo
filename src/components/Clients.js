export function Clients() {
  ...
  return `
    <section id="clients" class="py-6 md:py-8 bg-slate-50 px-4 md:px-6">
      
      <div class="relative w-full overflow-hidden flex marquee-wrapper">

        <div class="absolute top-0 left-0 h-full w-24 md:w-40 bg-linear-to-r from-slate-50 via-slate-50/90 to-transparent z-10 pointer-events-none"></div>
        <div class="absolute top-0 right-0 h-full w-24 md:w-40 bg-linear-to-l from-slate-50 via-slate-50/90 to-transparent z-10 pointer-events-none"></div>
